...
// ---------------------------------------------------------------------------
// The Owner's Command Center: a thin client over Supabase.
//
...
/// The three filters of the floating glass panel.
enum OwnerFilter { all, myActions, tlVerified }
          ...
          child: Container(
            ...
            child: Center(
              child: ToggleButtons(
                ...
                isSelected: [
                  for (final filter in OwnerFilter.values) filter == _filter,
                ],
                onPressed: (index) =>
                    setState(() => _filter = OwnerFilter.values[index]),
                children: [
